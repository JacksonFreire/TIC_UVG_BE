...
public class EnrollmentService {
    ...
    public void enrollUserToCourse(Long userId, Long courseId) {
        try {
            ...
            Course course = courseRepository.findById(courseId).orElseThrow(() -> new NoSuchElementException("Curso no encontrado"));
    ...
    public void enrollUserToEvent(Long userId, Long eventId) {
        try {
            User user = userRepository.findById(userId).orElseThrow(() -> new NoSuchElementException("Usuario no encontrado"));
            Event event = eventRepository.findById(eventId).orElseThrow(() -> new NoSuchElementException("Evento no encontrado"));
